...
3. 상황별 사용자 의사 입력 받기
  - 프로모션 할인
    - 프로모션 적용 상품에 대해 증정품을 가져오지 않았을 경우 증정품 추가 의사
      - 증정품을 가져올 프로모션 재고가 없을 시에는 의사를 묻지 않는다
      - 2+1할인에서 1개만 사는 경우 아무런 의사를 묻지 않는다
...
- 출력
  ...
  - [x] 기타 잘못된 입력의 경우: '[ERROR] 잘못된 입력입니다. 다시 입력해 주세요.'를 출력한다.
...
- 멤버십 할인
  - [x] 멤버십 회원은 프로모션 미적용 금액(일반 재고 결제)의 30%를 할인받는다.
